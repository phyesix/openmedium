...
<head>
	...
	<title>
		...
		if (function_exists('is_tag') && is_tag()) {
			single_tag_title("&quot; - Etiketi için arşivler"); echo '&quot; - ';
		} elseif (is_archive()) {
			wp_title(''); echo ' Arşiv - ';
		} elseif (is_search()) {
...
<body <?php body_class(); ?>>
	<nav id="nav">
		<ul class="nav-list">
			...
			?>
			<li id="nav-list-search"><form action="<?php bloginfo('siteurl'); ?>" class="searchform" method="get"><input type="text" id="s" name="s" value="" placeholder="Ara..." /></form></li>
		</ul>
	</nav>
